...
// Broker-agnostic task dispatch layer built on top of astra/mq.
// Only depends on the local mq module; brokers are provided by the caller.
require github.com/astra-go/astra/mq v0.0.0-00010101000000-000000000000
