...
| 阶段 | 工作量 | 人力 | 时间 | 实际进展 |
|------|--------|------|------|----------|
| 阶段 0 | 3.5 天 | 1 人 | 1 周 | ✅ 已完成 |
| 阶段 1 | 11 周 | 2 人 | 3 个月 | ✅ 已完成（2天） |
| 阶段 2 | 11 周 | 2-3 人 | 3 个月 | ⏳ 未开始 |
| 阶段 3 | 11 周 | 2 人 | 6 个月 | ⏳ 未开始 |
| **合计** | **~36 周** | **2-3 人** | **12 个月** | **阶段0+1已完成** |
...
|------|------|--------|------|
| 子模块数量 | 47 → 30 | < 35 | 达标 ✅ |
| CI 全量测试时间 | ~20 min | < 20 min | 持平 |
| 新用户上手时间 | ~2 小时 | ~15 分钟 | ⏳ 待阶段2 |
| 版本发布工作量 | 47 个 tag | 30 个 tag | -36% ✅ |
