...
type CommentServiceClient interface {
	...
	LikeComment(ctx context.Context, in *LikeCommentRequest, opts ...grpc.CallOption) (*CommentResponse, error)
}
...
func (c *commentServiceClient) LikeComment(ctx context.Context, in *LikeCommentRequest, opts ...grpc.CallOption) (*CommentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CommentResponse)
...
type CommentServiceServer interface {
	...
	LikeComment(context.Context, *LikeCommentRequest) (*CommentResponse, error)
...
func (UnimplementedCommentServiceServer) LikeComment(context.Context, *LikeCommentRequest) (*CommentResponse, error) {
...
var CommentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/proto/comment.proto",
}
